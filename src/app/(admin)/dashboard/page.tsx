...
const pedidosOracao = [
  { id: 1, nome: "Maria C.", tipo: "Saude", data: "02/03/2026", status: "Novo", resumo: "Pedido de cura para o meu filho..." },
  { id: 2, nome: "Jose M.", tipo: "Familia", data: "01/03/2026", status: "Em oracao", resumo: "Restauracao do meu casamento..." },
  { id: 3, nome: "Ana L.", tipo: "Financas", data: "28/02/2026", status: "Respondido", resumo: "Provisao para necessidades..." },
  { id: 4, nome: "Carlos N.", tipo: "Saude", data: "27/02/2026", status: "Novo", resumo: "Cirurgia marcada para proxima semana..." },
  { id: 5, nome: "Beatriz S.", tipo: "Relacionamento", data: "26/02/2026", status: "Em oracao", resumo: "Reconciliacao familiar..." },
];

const dashboardCards = [
  { icon: Camera, label: "Gerir Fotos", count: "48 fotos", color: "bg-blue-50 text-blue-600" },
  { icon: Video, label: "Gerir Videos", count: "12 videos", color: "bg-purple-50 text-purple-600" },
  { icon: Calendar, label: "Gerir Agenda", count: "8 eventos", color: "bg-green-50 text-green-600" },
  { icon: HandHeart, label: "Pedidos de Oracao", count: "5 novos", color: "bg-orange-50 text-orange-600" },
  { icon: Megaphone, label: "Gerir Avisos", count: "3 activos", color: "bg-red-50 text-red-600" },
  { icon: Edit, label: "Editar Informacoes", count: "Institucional", color: "bg-teal-50 text-teal-600" },
];

const statusColor: Record<string, string> = {
  Novo: "bg-blue-100 text-blue-700",
  "Em oracao": "bg-yellow-100 text-yellow-700",
...
export default function DashboardPage() {
  ...
  if (!loggedIn) {
    return (
      <div className="min-h-[80vh] flex items-center justify-center bg-church-neutral px-4">
        <motion.div
        ...
        >
          <div className="text-center mb-8">
            ...
            <h1
              style={{ fontFamily: "Merriweather, serif", fontWeight: 700, fontSize: "1.5rem", color: "#1E3A5F" }}
            >
              Area Administrativa
            </h1>
            <p className="text-church-text mt-2" style={{ fontSize: "0.9rem" }}>
              Acesso restrito a lideranca da I.I.T.E.D
            </p>
          </div>
  ...
  return (
    <div className="bg-church-neutral min-h-[80vh]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        {/* Header */}
        <div className="flex items-center justify-between mb-8">
          <div>
            <h1 style={{ fontFamily: "Merriweather, serif", fontWeight: 700, fontSize: "1.5rem", color: "#1E3A5F" }}>
            ...
            <table className="w-full">
              <thead>
                <tr className="bg-church-neutral">
                  ...
                  <th className="px-5 py-3 text-left text-church-text" style={{ fontSize: "0.8rem", fontWeight: 600 }}>Accoes</th>
                </tr>
              </thead>
              <tbody>
                {pedidosOracao.map((p) => {
