...
const contatoInfo = [
    { icon: MapPin, label: "Endereço", value: "Av. Julius Nyerere, 1250 — Sommerschield, Maputo", color: "bg-blue-50 text-blue-600" },
    ...
    { icon: Clock, label: "Horário", value: "Seg a Sex — 08:00 às 17:00", color: "bg-orange-50 text-orange-600" },
];
