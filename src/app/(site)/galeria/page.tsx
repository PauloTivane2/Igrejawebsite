...
const fotos = [
    { src: "https://images.unsplash.com/photo-1717201611909-0f75ee9b0b1e?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxhZnJpY2FuJTIwY2h1cmNoJTIwd29yc2hpcCUyMGNvbmdyZWdhdGlvbnxlbnwxfHx8fDE3NzI2MzkwMzB8MA&ixlib=rb-4.1.0&q=80&w=1080", cat: "Cultos", alt: "Culto de adoração" },
    { src: "https://images.unsplash.com/photo-1506630391771-a4428d1e6bcd?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxoYW5kcyUyMHByYXlpbmclMjBsaWdodCUyMHNwaXJpdHVhbHxlbnwxfHx8fDE3NzI2Mzc5MzF8MA&ixlib=rb-4.1.0&q=80&w=1080", cat: "Cultos", alt: "Momento de oração" },
    { src: "https://images.unsplash.com/photo-1709054754811-6c8d2d1ab015?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxjaHVyY2glMjBjaG9pciUyMHdvcnNoaXAlMjBzaW5naW5nfGVufDF8fHx8MTc3MjYzNzkzMnww&ixlib=rb-4.1.0&q=80&w=1080", cat: "Louvor", alt: "Ministério de louvor" },
    ...
    { src: "https://images.unsplash.com/photo-1624500055301-c62a900632f3?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxhZnJpY2FuJTIwcGFzdG9yJTIwcHJlYWNoaW5nJTIwY2h1cmNofGVufDF8fHx8MTc3MjYzOTAzMHww&ixlib=rb-4.1.0&q=80&w=1080", cat: "Congressos", alt: "Pregação" },
    { src: "https://images.unsplash.com/photo-1613632453420-4144fff27cf6?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxhZnJpY2FuJTIwZmFtaWx5JTIwcHJheWluZyUyMHRvZ2V0aGVyfGVufDF8fHx8MTc3MjYzOTAzNHww&ixlib=rb-4.1.0&q=80&w=1080", cat: "Cultos", alt: "Família na igreja" },
    ...
    { src: "https://images.unsplash.com/photo-1580011480023-9547f4740585?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxzdW5zZXQlMjBjcm9zcyUyMHNpbGhvdWV0dGUlMjBmYWl0aHxlbnwxfHx8fDE3NzI2Mzc5MzV8MA&ixlib=rb-4.1.0&q=80&w=1080", cat: "Congressos", alt: "Cruz ao pôr do sol" },
    { src: "https://images.unsplash.com/photo-1709390594155-9b1db07d2883?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxvcGVuJTIwYmlibGUlMjBzdHVkeSUyMGRldm90aW9uYWx8ZW58MXx8fHwxNzcyNjM3OTMxfDA&ixlib=rb-4.1.0&q=80&w=1080", cat: "Infantil", alt: "Estudo bíblico" },
];

const videos = [
    { title: "Culto de Celebração — Domingo", cat: "Pregações", duration: "1:32:00", thumb: "https://images.unsplash.com/photo-1624500055301-c62a900632f3?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxhZnJpY2FuJTIwcGFzdG9yJTIwcHJlYWNoaW5nJTIwY2h1cmNofGVufDF8fHx8MTc3MjYzOTAzMHww&ixlib=rb-4.1.0&q=80&w=1080" },
    { title: "Louvor e Adoração — Melhores Momentos", cat: "Louvores", duration: "45:00", thumb: "https://images.unsplash.com/photo-1709054754811-6c8d2d1ab015?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxjaHVyY2glMjBjaG9pciUyMHdvcnNoaXAlMjBzaW5naW5nfGVufDF8fHx8MTc3MjYzNzkzMnww&ixlib=rb-4.1.0&q=80&w=1080" },
    { title: "Testemunho de Transformação", cat: "Testemunhos", duration: "12:30", thumb: "https://images.unsplash.com/photo-1738744655193-706236bd4480?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxhZnJpY2FuJTIwY2hyaXN0aWFuJTIwY29tbXVuaXR5JTIwZ2F0aGVyaW5nfGVufDF8fHx8MTc3MjYzOTAzMXww&ixlib=rb-4.1.0&q=80&w=1080" },
    { title: "Palavra do Pastor — Série Esperança", cat: "Pregações", duration: "55:00", thumb: "https://images.unsplash.com/photo-1580011480023-9547f4740585?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxzdW5zZXQlMjBjcm9zcyUyMHNpbGhvdWV0dGUlMjBmYWl0aHxlbnwxfHx8fDE3NzI2Mzc5MzV8MA&ixlib=rb-4.1.0&q=80&w=1080" },
    { title: "Congresso de Adoração 2025 — Dia 1", cat: "Louvores", duration: "2:15:00", thumb: "https://images.unsplash.com/photo-1717201611909-0f75ee9b0b1e?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxhZnJpY2FuJTIwY2h1cmNoJTIwd29yc2hpcCUyMGNvbmdyZWdhdGlvbnxlbnwxfHx8fDE3NzI2MzkwMzB8MA&ixlib=rb-4.1.0&q=80&w=1080" },
    { title: "Baptismo nas Águas — Março 2025", cat: "Testemunhos", duration: "28:00", thumb: "https://images.unsplash.com/photo-1613632453420-4144fff27cf6?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxhZnJpY2FuJTIwZmFtaWx5JTIwcHJheWluZyUyMHRvZ2V0aGVyfGVufDF8fHx8MTc3MjYzOTAzNHww&ixlib=rb-4.1.0&q=80&w=1080" },
];
                    ...
                    <div className="flex justify-center mb-10">
                        <div className="inline-flex bg-church-neutral rounded-lg p-1">
                            <button
                                ...
                                className={`flex items-center gap-2 px-6 py-2.5 rounded-md transition-all ${tab === "fotos" ? "bg-church-primary text-white shadow-sm" : "text-church-text hover:bg-white"
                                    }`}
                            ...
                            <button
                                ...
                                className={`flex items-center gap-2 px-6 py-2.5 rounded-md transition-all ${tab === "videos" ? "bg-church-primary text-white shadow-sm" : "text-church-text hover:bg-white"
                                    }`}
                                style={{ fontWeight: 500, fontSize: "0.9rem" }}
                            >
                            ...
                            <div className="flex flex-wrap justify-center gap-2 mb-8">
                                {fotoCategorias.map((c) => (
                                    <button
                                        ...
                                        className={`px-4 py-2 rounded-full transition-all ${fotoFilter === c
                                ...
                                {fotosFiltradas.map((foto, i) => (
                                    ...
                                    >
                                        <div className="relative">
                                            {/* Using img for masonry layout since next/image needs fixed dimensions */}
