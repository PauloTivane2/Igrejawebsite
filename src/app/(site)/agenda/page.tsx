...
const eventosEspeciais = [
    { name: "Congresso de Adoração 2026", date: "15-17 de Maio", desc: "Três dias de adoração intensa e ministração da Palavra." },
    { name: "Vigília de Oração", date: "Última sexta de cada mês", desc: "Uma noite inteira de busca pela presença de Deus." },
    { name: "Semana de Jejum e Oração", date: "1-7 de Junho", desc: "Sete dias de consagração e intercessão pela igreja e nações." },
    { name: "Aniversário da Igreja", date: "12 de Agosto", desc: "Celebração especial com convidados e programação festiva." },
    { name: "Retiro de Casais", date: "20-22 de Setembro", desc: "Fim-de-semana de fortalecimento e renovação para casais." },
    { name: "Conferência de Jovens", date: "10-12 de Outubro", desc: "Impactando a nova geração com a Palavra de Deus." },
];
