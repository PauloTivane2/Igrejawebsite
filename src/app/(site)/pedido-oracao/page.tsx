...
export default function PedidoOracaoPage() {
  ...
  const onSubmit = (_data: FormData) => {
    setSubmitted(true);
    toast.success("Pedido de oração enviado com sucesso! A nossa equipa irá orar por si.");
    reset();
  ...
  return (
    <div>
      <PageBanner
        title="Envie o seu Pedido de Oração"
        ...
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} className="text-center mb-12">
            ...
            <motion.p
              ...
              style={{ fontFamily: "var(--font-merriweather), serif", lineHeight: 1.8 }}
            >
              &quot;Não enfrente as suas batalhas sozinho. A nossa equipa de intercessão está aqui para orar por si.&quot;
            </motion.p>
          </motion.div>
          ...
          {submitted ? (
            ...
            >
              ...
              <p className="text-church-text">
                Recebemos o seu pedido de oração. A nossa equipa de intercessão irá orar por si com todo o carinho.
              </p>
            </motion.div>
          ) : (
            <motion.form
            ...
            >
              ...
              <motion.div variants={fadeUp} custom={4}>
                ...
                <textarea
                  id="pedido"
                  rows={5}
                  {...register("pedido", { required: "Pedido é obrigatório" })}
                  ...
                  placeholder="Partilhe o seu pedido de oração..."
                />
          ...
          <motion.p
            ...
            style={{ fontFamily: "var(--font-merriweather), serif", fontSize: "0.9rem" }}
          >
