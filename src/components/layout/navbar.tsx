                    ...
                    <Link href="/" className="flex items-center gap-2 shrink-0">
                        ...
                        <div className="flex flex-col">
                            <span
                                ...
                                style={{ fontFamily: "var(--font-merriweather), serif", fontWeight: 700, fontSize: "1rem", lineHeight: 1.2 }}
                            >
                                I.I.T.E.D
                            </span>
                    ...
                    <div className="hidden lg:flex items-center gap-1">
                        {navLinks.map((link) => (
                            <Link
                                key={link.path}
                                href={link.path}
                                className={`px-3 py-2 rounded-md transition-colors ${pathname === link.path
                        ...
                        <div className="px-4 py-4 space-y-1">
                            {navLinks.map((link) => (
                                <Link
                                    key={link.path}
                                    href={link.path}
                                    className={`block px-4 py-3 rounded-md transition-colors ${pathname === link.path
                                            ? "text-church-primary bg-church-primary/10"
                                            : "text-church-text hover:text-church-primary hover:bg-church-primary/5"
                                        }`}
                                >
