                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
                    ...
                    <div>
                        <div className="flex items-center gap-2 mb-4">
                            ...
                            <span
                                ...
                                style={{ fontFamily: "var(--font-merriweather), serif", fontWeight: 700, fontSize: "1.1rem" }}
                            >
                                I.I.T.E.D
                            </span>
                        </div>
                        ...
                        <p
                            ...
                            style={{ fontFamily: "var(--font-merriweather), serif", fontSize: "0.8rem" }}
                        >
                    ...
                    <div>
                        <h4
                            ...
                            style={{ fontFamily: "var(--font-merriweather), serif", fontWeight: 700, fontSize: "1rem" }}
                        >
                            Links Rápidos
                        </h4>
                    ...
                    <div>
                        ...
                        <div className="flex gap-3 mt-4">
                            {[
                                ...
                                { Icon: Phone, label: "WhatsApp", href: "https://wa.me/258841234567" },
                            ].map((s) => (
                                <a
                                    key={s.label}
                                    href={s.href}
